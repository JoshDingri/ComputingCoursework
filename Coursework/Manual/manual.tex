...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{./Manual/Images/adddata.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{./Manual/Images/department2.png}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{./Manual/Images/myinfp2.png}
\end{figure}
