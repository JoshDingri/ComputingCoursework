...
\Large
\scalebox{0.36}{
\hspace*{-8cm}\begin{tabular}{|p{4cm}|p{2m}|p{3cm}|p{3cm}|}
\hline
...
\multicolumn{1}{|c|}{Web Based Application}    & \multicolumn{1}{c|}{Using online services}          & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Access from anywhere (meets client needs)\\ Available to use by multiple people\\ User friendly\end{tabular}} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Company will have to learn how to use it\\ Extra security needed (log-ins)\\Will be hard to program.\end{tabular}}                      \\ \hline
\multicolumn{1}{|c|}{PyQt GUI Application}         & \multicolumn{1}{c|}{Providing a GUI interface for the database using PyQt}                                 & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}GUI interface means it is easy to use for staff\\ I will be learning PyQt in class to help with this solution\end{tabular}}   & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Cannot be logged on from anywhere\\ Not ideal as it does not fully reach the clients needs\end{tabular}}                        \\ \hline
