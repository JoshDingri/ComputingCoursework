...
The physical form that colleagues will fill in to say which hardware device they would like, which the line manager then signs, will stay the same. This is because I feel signing a paper document is easier than signing on a computer, also I do not think a computerised version of this would make things any easier. The current form does not need to be redesigned as it includes all the information needed for line managers to check, also the fact that staff have used these forms for long time means they will not have to get used to another version.
