...
\item The search function will take the user to an interface which will allow them to search for a staff member and be shown which hardware devices they own. The user will be able to enter text and get results based on specified text. This search could also be performed by going to the staff database and using the search function there, but this may be used frequently and so is placed here for convenience.
...
\item Line manager's have unique usernames and a password that they may change at any time. Upon first using the system their password will be issued by IT staff. Their username at the moment will be a 5 digit number allocated to them by IT staff, however this username may change depending on the users needs. (the best way to do this will be via email). 
...
\begin{figure}[H]
\includegraphics[width=.9\textwidth,height=.9\textheight,keepaspectratio]{PS.jpg}
\caption{}
\end{figure}
...
There are no calculations performed from data transformation processes at this stage.
...
\underline {\textbf{Add Data GUI}}

The prototype below shows a basic GUI to add data to the database. I linked it with the SQL file and added placeholder text. It was simple to make so designing this in the implementation should be no problem.

\begin{figure}[H]
\includegraphics[width=\textwidth]{AddDataUIDesign.jpg}
\caption{Add data design}
\end{figure}

\newpage

\underline {\textbf{Email Prototype}}

The prototype below displays a simple email GUI. I did not know initially how to start setting up email but it was important to find out so it would make the implemenation a lot easy as this is one of my goals.

\begin{figure}[H]
\includegraphics[width=\textwidth]{EmailDesign.jpg}
\caption{GUI for sending emails.}
\end{figure}

\textbf{The SMTP can be set to Volac, which will work with all staff emails. Below is the email setup for my prototype email.}

        self.mail = smtplib.SMTP("smtp.live.com",587) \par
        self.mail.ehlo() \par 
        self.mail.starttls() \par
        self.mail.login("EMAIL","PASSWORD") \par
...
\begin{center}
	...
	Hardware Warranty & IT Staff Input Information. Boolean value selection. \\ \hline
	Hardware Warranty  Expiration Date & When the calender date is clicked for data inputs the date will automatically enter. \\ \hline
	...
	Search Results & This output will display the results for the search specified depending on which table is selected. \\ \hline
    \end{longtable}
\end{center}
...
For the following SQL statements, I have formatted them with the python .format() function to format the SQL strings.
...
\begin{center}
    \begin{longtable}{|p{2.5cm}|p{2cm}|p{1.5cm}|p{2cm}|p{3cm}|}
        \hline
        \textbf{Data Item} & \textbf{Validation} & \textbf{Presence Check?} & \textbf{Example} & \textbf{Comments} \\ \hline
StaffID                              & Auto generated - No validation criteria        &  N/A & 5        & not NULL and unique  \\ \hline
...
HardwareID                         &  Auto generated - No validation criteria        &  N/A & 121        & not NULL and unique \\ \hline
...
DeviceID                     &  Auto generated - No validation criteria        &  N/A & 24        & not NULL and unique                    \\ \hline
DeviceName                         & Length                       &Yes            & Phone, Laptop, Tablet                &  Ensures a length of a device is not more than 15 characters                     \\ \hline
Hardware MakeID                    &  Auto generated - No validation criteria        &  N/A & 24        & not NULL and unique                       \\ \hline
Hardware Make                        & Length               &Yes                    & iPhone                & Ensures the length of a make is not more than 15 characters                      \\ \hline
Hardware ModelID		& Auto generated - No validation criteria        &  N/A & 24        & not NULL and unique                        \\ \hline
Hardware Model                      & Length            &Yes                       & 5S                    & Ensures no more than 15 characters will be entered                       \\ \hline
DepartmentID 	& Auto generated - No validation criteria        &  N/A & 24        & not NULL and unique	\\ \hline
Department Name	& Length	&Yes	& Financing		& Allows for 25 characters to be entered for the department	\\ \hline
LocationID 		& Auto generated - No validation criteria        &  N/A & 24        & not NULL and unique		\\ \hline
